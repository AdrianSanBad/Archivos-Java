...
import Controlador.Ctrl_CategoriaGasto;
import java.awt.Dimension;
import javax.swing.JOptionPane;
import modelo.CategoriaGasto;

public class JInternalFrame_RegiCateGas extends javax.swing.JInternalFrame {

    public JInternalFrame_RegiCateGas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nueva categoria Gasto");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Ctrl_CategoriaGasto controlCategoria = new Ctrl_CategoriaGasto();
...
// Validar campos vacíos
        if (txt_descripcion.getText().isEmpty()) {
            ...
            if (!controlCategoria.existeCategoria(txt_descripcion.getText().trim())) {
                categoriaGasto.setDescripcion(txt_descripcion.getText().trim());
                categoriaGasto.setEstado(1);

                if (controlCategoria.guardar(categoriaGasto)) {
