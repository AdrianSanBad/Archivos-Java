...
public class JInternalFrame_EditCate extends javax.swing.JInternalFrame {

    private int idCategoria;

    public JInternalFrame_EditCate() {
        initComponents();
    ...
    private void CargarTablaCategorias() {
        ...
        try {
            ...
            JInternalFrame_EditCate.jTable_Categorias = new JTable(model);
            JInternalFrame_EditCate.jScrollPane1.setViewportView(JInternalFrame_EditCate.jTable_Categorias);
    ...
    private void actualizarCategoria() {
        ...
        if (idCategoria != 0 && !descripcion.isEmpty()) {
            try {
                Connection con = Conexion.conectar();
